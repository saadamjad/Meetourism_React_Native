...
const App = (props) => {
  ...
  const component = () => {
    return <View style={{ backgroundColor: theme.primaryColor, flex: 1 }}  >
      <LongHeader
        ...
        headerText="Gallery"
      />
      <Text style={{ color: 'white', fontSize: 20, textAlign: 'center', marginTop: 10 }} > User didn't upload any images  </Text>

    </View>
  }
  return (
    emptyImages ? component() :
      <Swiper
