            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  height: 30,
                  borderRadius: 150,
                  backgroundColor: state.selected == i ? '#A8FFFF' : '#E7E7E7',
                  borderWidth: 1,
                }}
                onPress={() => {
              ...
              <View style={{marginLeft: 20}}>
                <Text style={{color: theme.textColor.blackColor, fontSize: 25}}>
                  {val.name}
                </Text>
                <Text style={{color: theme.textColor.blackColor, fontSize: 8}}>
                  {val.description}
                </Text>
              </View>
            </View>
